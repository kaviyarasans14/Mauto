...
class Version20180307132115 extends AbstractMauticMigration
{
    /**
     * @param Schema $schema
     *
    ...
    {
        if ($schema->hasTable(MAUTIC_TABLE_PREFIX.'accountinfo')) {
    ...
    public function up(Schema $schema)
    {
        ...
        $sql = <<<SQL
CREATE TABLE {$this->prefix}accountinfo (
  ...
  needpoweredby int(11) DEFAULT NULL,
  PRIMARY KEY (id)
