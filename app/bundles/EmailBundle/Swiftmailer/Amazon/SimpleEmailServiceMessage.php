...
final class SimpleEmailServiceMessage
{
     ...
     *
     * @see http://docs.aws.amazon.com/ses/latest/APIReference/API_Destination.html
     */
     ...
     * @return SimpleEmailServiceMessage $this
     *
     * @see http://docs.aws.amazon.com/ses/latest/APIReference/API_Message.html
     */
     ...
     * @return SimpleEmailServiceMessage $this
     *
     * @see https://docs.aws.amazon.com/ses/latest/DeveloperGuide/event-publishing-send-email.html
     ...
     * @return SimpleEmailServiceMessage $this
     */
    public function setMessageTags($message_tags = [])
    {
    ...
    public function encodeRecipients($recipient)
    {
        if (is_array($recipient)) {
            return join(', ', array_map([$this, 'encodeRecipients'], $recipient));
        }
