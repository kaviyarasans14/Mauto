            ...
            <div role="tabpanel" class="tab-pane fade in active bdr-w-0" >
                <div class="pt-md pr-md pl-md pb-md" id="paymenthistory">
                    ...
                    <div class="panel-heading">
                        <h3 class="panel-title"><?php echo $view['translator']->trans('mautic.cancel.subscription.title'); ?></h3>
                    </div>
                    <div class="panel-body">
                        <br>
                        <p style="text-align: left;font-family: 'Open Sans', Helvetica, Arial, sans-serif;font-size:13px;"><?php echo $view['translator']->trans('mautic.cancel.description'); ?></p>
                        <br>
                        <a href="javascript: void(0);" onclick="Mautic.closeModalAndRedirect('.<?php echo $typePrefix; ?>-type-modal', '<?php echo $view['router']->path($actionRoute, ['objectAction' => 'cancel']) ?>');" class="cancel-subscription" ><?php echo $view['translator']->trans('mautic.cancel.subscription.title'); ?></a>
                        <br>
                        <br>
                    </div>
                </div>
